...
<body>
    ...
    <div id="login-screen" class="fixed inset-0 z-50 flex items-center justify-center bg-[#0f172a]">
        <div class="w-full max-w-md bg-white rounded-3xl p-10 text-center mx-4 shadow-2xl border border-slate-100">
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight">PROPERTY INTELEGENT</h1>
            <p class="text-sm text-slate-400 mb-8 mt-1 font-medium">Ruang Masbay 2026</p>
            <div class="relative mb-4">
                <input type="password" id="passInput" placeholder="Enter Security Code" 
                class="w-full p-4 rounded-xl border border-slate-200 text-center outline-none focus:ring-2 focus:ring-slate-900 transition-all">
            </div>
            ...
            <p id="errorMsg" class="text-red-500 text-xs mt-4 font-bold hidden uppercase tracking-widest">Wrong Security Code</p>
        </div>
    </div>
    ...
    <div id="main-app" class="hidden min-h-screen pb-20">
        <nav class="bg-white border-b px-6 py-5 flex justify-between items-center sticky top-0 z-40">
            <div class="flex flex-col">
                <span class="font-black tracking-tighter text-xl text-slate-900">RUANG MASBAY</span>
                <span class="text-[9px] font-bold text-slate-400 -mt-1 tracking-[0.2em]">PROPERTY INTELEGENT 2026</span>
            </div>
            <div class="text-[10px] bg-slate-900 text-white px-4 py-1.5 rounded-full font-bold uppercase tracking-widest shadow-sm">Active Session</div>
        </nav>

        <div id="marquee" class="marquee-container">
            <div class="marquee-text">
                +++ Ruang Masbay 2026 Property Intelegent +++ Advanced KPR Analysis System +++ Digital Marketing Personal Portfolio +++ Exclusive Access Granted +++ Ruang Masbay 2026 Property Intelegent +++
            </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto p-6 mt-4 grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-5 space-y-6">
                <div class="luxury-card p-8">
                    <h2 class="label-style mb-8 border-b pb-4">Financial Parameters</h2>
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <p class="text-[11px] text-slate-400 mt-2">Nett Price (Excl. PPN): <span id="excPPNLabel" class="font-bold text-slate-600">Rp 0</span></p>
                        </div>
                ...
                <div class="p-6 bg-slate-900 rounded-2xl border border-slate-800 shadow-lg">
                    <div class="flex items-start gap-3">
                        ...
                        <p class="text-[11px] text-slate-300 leading-relaxed">
                            <b>NOTE:</b> Uang Tanda Jadi (Booking Fee) sudah termasuk dalam total harga properti dan bersifat mengurangi nilai kewajiban Down Payment (DP).
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-7 space-y-6">
                <div class="dark-card p-10 shadow-2xl relative overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800">
                    <div class="relative z-10">
                        <p class="label-style text-slate-500 mb-2">Monthly Installment</p>
                        <h3 id="monthlyInstallment" class="text-5xl md:text-6xl font-bold tracking-tighter text-white">Rp 0</h3>
                        
                        <div class="grid grid-cols-2 gap-6 mt-10 pt-8 border-t border-white/5 text-sm">
                            <div>
                                <p class="text-[10px] uppercase opacity-40 tracking-widest">Credit Ceiling</p>
                                <p id="plafon" class="text-xl font-bold highlight-gold">Rp 0</p>
                            </div>
                            <div class="text-right">
                                <p class="text-[10px] uppercase opacity-40 tracking-widest">Property Value</p>
                                <p id="valInc" class="text-xl font-bold">Rp 0</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="luxury-card p-6 border-b-4 border-slate-900">
                        <p class="label-style mb-1 text-slate-400 font-bold">Legal Fee (Est. 5.5%)</p>
                        <p id="resLegal" class="text-xl font-bold text-slate-800">Rp 0</p>
                        <p class="text-[9px] text-slate-400 mt-1 uppercase font-bold italic tracking-tighter">AJB, BPHTB, BN</p>
                    </div>
                    <div class="luxury-card p-6 border-b-4 border-slate-900">
                        <p class="label-style mb-1 text-slate-400 font-bold">KPR Process Fee</p>
                        <p id="resAkadTotal" class="text-xl font-bold text-slate-800">Rp 0</p>
                        <p class="text-[9px] text-slate-400 mt-1 uppercase font-bold italic tracking-tighter">Provisi, Admin, Insurance</p>
                    </div>
                </div>

                <div class="luxury-card overflow-hidden h-[380px] flex flex-col">
                    <div class="p-5 border-b bg-slate-50 flex justify-between items-center">
                        <p class="label-style">Full Tenor Amortization Table</p>
                    </div>
                    <div class="overflow-y-auto flex-grow">
                        <table class="w-full text-left text-sm">
                            <thead class="bg-slate-50 text-[10px] uppercase text-slate-400 sticky top-0 z-10 shadow-sm">
                                <tr>
        ...
        function calculate() {
            ...
            for(let i=1; i<=n; i++) {
                ...
                tableHTML += `<tr class="hover:bg-slate-50 transition">
                    <td class="px-6 py-3 font-bold text-slate-400 text-[10px]">${i}</td>
                    <td class="px-6 py-3 text-slate-600 text-[10px]">${formatIDR(principalBln)}</td>
                    <td class="px-6 py-3 text-right font-bold text-slate-900 text-[10px]">${formatIDR(Math.max(0, balance))}</td>
                </tr>`;
            }
